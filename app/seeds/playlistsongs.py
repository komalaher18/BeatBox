...
def seed_playlistsongs():
    ...
    playlist3 = Playlist(userId='2',title='Walkman', playListImage="https://static.gettyimages.com/display-sets/creative-landing/images/GettyImages-1448734171.jpg")
    ...
    song1.playlists.extend([playlist1])
    song2.playlists.extend([playlist2])
    song3.playlists.extend([playlist3])
    song4.playlists.extend([playlist1])
    song5.playlists.extend([playlist2])
    song6.playlists.extend([playlist3])
    song7.playlists.extend([playlist1])
    song8.playlists.extend([playlist2])
    song9.playlists.extend([playlist3])
    song10.playlists.extend([playlist1])
    song11.playlists.extend([playlist2])
    song12.playlists.extend([playlist3])
    song13.playlists.extend([playlist1])
