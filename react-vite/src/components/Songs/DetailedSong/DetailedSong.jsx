  ...
  return (
    <div>
      <div className="detailedSong-container">
        <div className="div">
          <div className="detailSong-info">
            <h1 style={{ marginLeft: "100px", position: "relative" }}>
              <span
                style={{
                  position: "absolute",
                  left: "-20px",
            ...
            <h3 className="songdetail-genre">{song.genre}</h3>
            <img
              src={song.songImage}
          ...
          {allComments.length === 0 &&
            ...
            sessionUser.id !== song.userId && (
              <span className="">
                <div>
                  <h3 style={{ paddingLeft: "1rem" }}>
                    <i className="fa-solid fa-comment"></i> Be the first person
                    to comment
                  </h3>
                </div>
              </span>
                ...
                <div>
                  <div style={{ display: "inline-block", marginRight: "10px" }}>
                    <OpenModalButton
                      ...
                      modalComponent={
                        <EditComment props={{ comment: comment, songId: id }} />
                      }
                    />
                  </div>
